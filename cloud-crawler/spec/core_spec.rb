  ...
  describe CrawlJob do
    ...
    shared_examples_for "crawl" do
      it "should crawl all the html pages in a domain by following <a> href's" do
        ...
        CloudCrawler.crawl(pages[0].url, @opts).should have(4).pages
      end
      ...
      it "should follow http redirects" do
        ...
        CloudCrawler.crawl(pages[0].url, @opts).should have(3).pages
      end
      ...
      it "should follow with HTTP basic authentication" do
        ...
        CloudCrawler.crawl(pages.first.auth_url, @opts).should have(3).pages
      end
      ...
      it "should accept multiple starting URLs" do
        ...
        CloudCrawler.crawl([pages[0].url, pages[2].url], @opts).should have(4).pages
      end
